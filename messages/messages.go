...
const (
	HELP_MESSAGE = "راهنمای استفاده از ربات\n\n" +
		...
		"/bid hw1 2.9\n\n" +
		"2️⃣ مناقصه هلندی به این صورت است که از یک نمره کم شروع می‌شود و ذره ذره افزایش می‌یابد. اولین کسی که با توجه به نمره فعلی پیشنهاد را قبول کند، برنده مناقصه خواهد بود.\n" +
		...
		"/start dutch_reverse_auction hw2 0 0.02\n\n" +
		"برای شرکت در مناقصه باید از دستور /bid استفاده کنید و در ادامه نام مناقصه را وارد کنید. مثال:\n" +
		"/bid hw2\n\n" +
		"3️⃣ مناقصه مخفی همان sealed bid auction است که در آن هر کس تنها یک بار می‌تواند پیشنهاد خود را ثبت کند. پیشنهادات مخفی بوده و تا زمان پایان مناقصه هیچ کس نمی‌تواند بفهمد چه کسی چه مقداری پیشنهاد داده است.\n" +
		"برنده در این نوع مناقصه کسی است که کمترین نمره را پیشنهاد داده است. در صورت تساوی بودن پیشنهادات، برنده کسی است که اولین پیشنهاد را ثبت کرده است.\n" +
		"مدت زمان مناقصه یک دقیقه است.\n" +
		"برای شروع کردن این نوع مناقصه به یک ورودی نام مناقصه احتیاج است. مثال:\n" +
		"/start sealed_bid_auction hw3\n" +
		"برای شرکت در مناقصه باید در چت شخصی ربات از دستور /bid استفاده کنید و در ادامه نام مناقصه و نمره پیشنهادی خود را وارد کنید. مثال:\n" +
		"/bid hw3 2.9\n"
	...
	START_DUTCH_REVERSE_AUCTION_MESSAGE = " مناقصه هلندی جدید %s شروع شد.\n\n" +
		"در این مناقصه از نمره %f شروع می‌کنیم و هر ۱۰ ثانیه ارزش سوال %f افزایش می‌یابد.\n" +
	...
	DUTCH_REVERSE_AUCTION_PRICE_RAISED_MESSAGE = "نمره سوال افزایش یافت و ارزش فعلی سوال %f است.\n"

	DUTCH_REVERSE_AUCTION_BID_ACCEPTED_MESSAGE = "پیشنهاد %s با موفقیت پذیرفته شد!\n"
